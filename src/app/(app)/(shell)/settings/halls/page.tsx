...
const SECTION_LABEL = { MEN: "رجال", WOMEN: "نساء", MIXED: "مشترك" } as const;
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-ink-soft">
                      ...
                      {h.capacitySeated
                        ? ` · ${formatNumber(h.capacitySeated, locale)} ضيف`
                        : ""}
                      {h.basePriceFils
